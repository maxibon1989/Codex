...
- `/quote/investment-appendix` for ROI scenarios, formulas, charts, and executive summary metrics
...
No inline review comments were present in the provided diff metadata; this update pushes a cleaned PR-ready commit and refreshed documentation wording.
